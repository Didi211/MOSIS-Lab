...
class ListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myPlaces : ListView = requireView().findViewById<ListView>(R.id.my_places_list)
        myPlaces.adapter = ArrayAdapter<MyPlace>(view.context, android.R.layout.simple_list_item_1,myPlacesViewModel.myPlacesList)
        myPlaces.setOnItemClickListener(object: AdapterView.OnItemClickListener{
        ...
        myPlaces.setOnCreateContextMenuListener(object: View.OnCreateContextMenuListener{
